...
const en = {
  ...
  "import.stage.previews": "Making previews…",
  ...
  "backup.open": "Open",
  "share.cta": "Share chat",
  "share.again": "Share link again",
  "share.stop": "Stop sharing",
  "share.message": "{chat} — Boydem\n{link}",
...
const he: Record<StringKey, string> = {
  ...
  "common.done": "סיום",
  "common.cancel": "ביטול",
  "common.showFewer": "להציג פחות",
  "common.showAll": "להציג הכול ({count})",
  "common.viewAll": "להציג הכול ({count})",
  ...
  "account.drive.restoring": "מורידים {n} מתוך {count}…",
  ...
  "import.stage.deriving-key": "מצפינים…",
  ...
  "import.stage.previews": "מכינים תצוגה מקדימה…",
  "import.unlock.heading": "הסיסמה של {chat}",
  "import.field.passphrase": "סיסמה",
  "import.field.again": "הקלידו שוב",
  "import.field.mismatch": "השתיים לא זהות.",
  "import.field.tooShort":
    "השתמשו ב־8 תווים לפחות. הסיסמה הזו היא הדרך היחידה חזרה אל הארכיון.",
  "import.submit.merge": "הוספה לצ׳אט",
  "import.error.wrongPassphrase": "הסיסמה הזו לא פותחת את הארכיון.",
  "import.error.unfinished": "הייבוא לא הסתיים.",
  "import.error.unreadable": "אי אפשר לקרוא את הייצוא הזה.",
  ...
  "reader.deriving": "מפענחים…",
  "reader.locked.title": "נעול",
  "reader.locked.heading": "הארכיון הזה נעול",
  "reader.locked.body":
    "המפתח שלו לא נמצא בצרור המפתחות של הטלפון — מצב רגיל אחרי שחזור מגיבוי, התקנה מחדש, או אם הארכיון הגיע ממכשיר אחר. הסיסמה שלכם פותחת אותו ומחזירה את המפתח למקומו.",
  ...
  "bubble.omitted": "וואטסאפ השאיר את המדיה הזו מחוץ לייצוא — היא לא נמצאת בארכיון.",
  "bubble.deleted": "ההודעה הזו נמחקה",
  "bubble.damaged": "התמונה הזו פגומה.",
  "bubble.unreachable": "התמונה לא נטענה מ־Drive.",
  "bubble.kind.video": "וידאו",
  "bubble.kind.audio": "הקלטה או אודיו",
  "bubble.kind.file": "קובץ",
  "bubble.notPlayable": "שמור בארכיון. אי אפשר לנגן אותו כאן עדיין.",
  ...
  "info.locked": "הארכיון הזה נעול. פתחו אותו מהספרייה והזינו את הסיסמה.",
  "info.error.heading": "אי אפשר לקרוא את הארכיון הזה",
  "info.media.title": "מדיה ({count})",
  "info.media.seeAll": "להציג הכול",
  "info.media.facts": "{files} · {size}",
  ...
  "media.otherKinds.one":
    "גם קובץ וידאו או אודיו אחד שמור בארכיון. אי אפשר לנגן אותו באפליקציה עדיין — הוא נמצא בקובץ, ואפשר לפתוח אותו באתר.",
  "media.otherKinds.other":
    "גם {count} קובצי וידאו ואודיו שמורים בארכיון. אי אפשר לנגן אותם באפליקציה עדיין — הם נמצאים בקובץ, ואפשר לפתוח אותם באתר.",
  "media.empty": "אין בארכיון הזה תמונות. אם היו תמונות בייצוא, הן היו מופיעות כאן.",
  ...
  "remove.ready.body":
    "הצ׳אט יוסר מהטלפון הזה. העותק ב־Drive, אם יש, נשאר.",
  "remove.ready.confirm": "הבנתי",
  "remove.cta": "הסרה מהטלפון הזה",
  "remove.working": "מסירים…",
  "remove.failed": "הארכיון הזה לא הוסר: {error}",
  "remove.noteWhatsApp":
  ...
  "backup.open": "פתיחה",
  "share.cta": "שיתוף הצ׳אט",
  "share.again": "שליחת הקישור שוב",
  "share.stop": "הפסקת השיתוף",
  "share.message": "{chat} — בוידעם\n{link}",
  "status.uploading": "בהעלאה · {percent}%",
  ...
  "backup.uploading": "בהעלאה ל־Drive · {percent}%",
  "backup.inDrive": "ב־Google Drive שלכם",
  "info.drive": "גיבוי",
  "info.size": "נפח",
  "info.passphrase": "סיסמה",
  ...
  "help.limits.body": "וואטסאפ מייצא לכל היותר כ־40,000 הודעות — או 10,000 עם מדיה — מהחדשה ביותר אחורה. ייצוא נוסף בהמשך מוסיף את מה שחדש.",
  "help.about.title": "על {app}",
  "help.about.body": "{app} הופך ייצוא מוואטסאפ לעותק שהוא שלכם, ואז מראה לכם איך למחוק את המקור בעצמכם.",
};
